...
namespace Backend.Services
{
    ...
    public class ProductService
    {
        ...
        private readonly List<Product> _users = new() // Definisco privata la Lista di prodotti perché vorrei che sia accessibile solo alla stessa classe
        {
        ...
        //public List<Product> GetAll() => _users;
        ...
        //public Product? GetById(int id) => _users.FirstOrDefault(p => p.Id == id);
        ...
        public Product Add(Product newProduct)
        {
            ...
            _users.Add(newProduct); // aggiungo il nuovo prodotto alla lista
