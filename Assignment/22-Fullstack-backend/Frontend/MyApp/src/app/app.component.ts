...
export class AppComponent {
  ...
  // Il BreakpointObserver osserva i cambiamenti nelle dimensioni dello schermo
  // il costruttore imposta un osservatore per rilevare se la larghezza dello schermo è inferiore a 800px
  // Se è inferiore, imposta isMobile a true, altrimenti a false
