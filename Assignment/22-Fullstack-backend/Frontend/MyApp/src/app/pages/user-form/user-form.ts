...
@Component({
  ...
  template: `
    ...
    <form (ngSubmit)="save()">
      ...
      <label>
        Città: 
        <input [(ngModel)]="model.address.citta" 
        name="addressCitta" required>
      </label>
      <br />
      <label>
        Via: 
        <input [(ngModel)]="model.address.via" 
        name="addressVia" required>
      </label>
      <br />
      <label>
        CAP: 
        <input [(ngModel)]="model.address.cap" 
        name="addressCap" required>
      </label>
      <br />
